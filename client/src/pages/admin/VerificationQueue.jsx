  ...
  return (
    <DashboardLayout title="Admin" nav={ADMIN_NAV}>
      <div className="flex flex-col gap-xl">
        <h1 className="text-[24px] font-bold text-text-primary">Verification queue</h1>
        ...
        {loading ? (
          ...
          <EmptyState icon="gpp_good" title="Nothing pending" description="Beneficiaries awaiting verification will appear here." />
        ) : (
            ...
            {beneficiaries.map((b) => (
              <div key={b._id} className="flex items-center justify-between py-lg gap-md flex-wrap">
                <div>
                  ...
                  <p className="text-[13px] text-text-secondary">Account: {b.userId?.email || 'Unknown'}</p>
                </div>
